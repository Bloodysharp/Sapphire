...
#include "../sapphire dx11/examples/example_win32_directx11/colors.h"
extern ImFont* ico_0;
...
bool ImGui::ButtonEx(const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags)
{
    ...
    it_anim->second.background_color0 = ImLerp(it_anim->second.background_color0, IsItemActive() ? c::button_push_gradient_active : hovered ? c::button_push_gradient_hovered : c::button_push_gradient, g.IO.DeltaTime * 6.f);
    it_anim->second.background_color1 = ImLerp(it_anim->second.background_color1, IsItemActive() ? c::button_pop_gradient_active : hovered ? c::button_pop_gradient_hovered : c::button_pop_gradient, g.IO.DeltaTime * 6.f);
    ...
    RenderFrame(bb.Min, bb.Max, GetColorU32(c::button_push_gradient), true, style.FrameRounding);
    ImGui::ShadeVertsLinearColorGradientKeepAlpha(ImGui::GetWindowDrawList(), vtx_idx_1, ImGui::GetWindowDrawList()->VtxBuffer.Size, bb.Min, bb.Max - ImVec2(size_arg.x, 0), GetColorU32(it_anim->second.background_color0), GetColorU32(it_anim->second.background_color1));
...
bool ImGui::Tab(const char* ico, const char* label, bool selected, const ImVec2& size_arg, bool tabs, ImGuiButtonFlags flags)
{
    ...
    it_anim->second.background_color = ImLerp(it_anim->second.background_color, selected ? c::tab_active : ImColor(0, 0, 0, 0), g.IO.DeltaTime * 6.f);
    it_anim->second.glow_color = ImLerp(it_anim->second.glow_color, selected ? c::glow_active : ImColor(0, 0, 0, 0), g.IO.DeltaTime * 6.f);

    if (tabs) {

        ImGui::GetWindowDrawList()->AddRectFilled(bb.Min, bb.Max - ImVec2(size_arg.x - 2, 0), GetColorU32(it_anim->second.background_color), 0);
        ImGui::GetWindowDrawList()->AddRectFilledMultiColor(bb.Min, bb.Max - ImVec2(size_arg.x - 11, 0), GetColorU32(it_anim->second.glow_color), ImColor(32, 31, 37, 0), ImColor(32, 31, 37, 0), GetColorU32(it_anim->second.glow_color));

        ImGui::GetWindowDrawList()->AddText(ico_0, 23, ImVec2(bb.Min.x + 20, bb.Max.y + style.FramePadding.y - 26), GetColorU32(it_anim->second.text_color), ico);
        ImGui::GetWindowDrawList()->AddText(ImVec2(bb.Min.x + 51, bb.Max.y + style.FramePadding.y - 24), GetColorU32(it_anim->second.text_color), label);
    }
    else {
        ...
        PushStyleColor(ImGuiCol_Text, GetColorU32(it_anim->second.text_color));
        RenderTextClipped(bb.Min + style.FramePadding + ImVec2(3, 0), bb.Max - style.FramePadding, label, NULL, &label_size, style.ButtonTextAlign, &bb);
        PopStyleColor();
...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    it_anim->second.gradient_color0 = ImLerp(it_anim->second.gradient_color0, *v ? c::checkbox_gradient_start : hovered ? ImColor(0, 0, 0, 0) : ImColor(0, 0, 0, 0), g.IO.DeltaTime * 6.f);
    it_anim->second.gradient_color1 = ImLerp(it_anim->second.gradient_color1, *v ? c::checkbox_gradient_end : hovered ? ImColor(0, 0, 0, 0) : ImColor(0, 0, 0, 0), g.IO.DeltaTime * 6.f);
    it_anim->second.checkmark_color = ImLerp(it_anim->second.checkmark_color, *v ? c::checkbox_mark : hovered ? ImColor(0, 0, 0, 0) : ImColor(0, 0, 0, 0), g.IO.DeltaTime * 9.f);
...
bool ImGui::BeginCombo(const char* label, const char* preview_value, float val, ImGuiComboFlags flags, bool multi)
{
    ...
    ImGui::ShadeVertsLinearColorGradientKeepAlpha(ImGui::GetWindowDrawList(), vtx_idx_1, ImGui::GetWindowDrawList()->VtxBuffer.Size, bb.Min, ImVec2(value_x2 - CalcItemWidth() - 32, bb.Max.y), GetColorU32(c::combo_push_gradient), GetColorU32(c::combo_pop_gradient));
    ...
    PushStyleColor(ImGuiCol_WindowBg, GetColorU32(c::combo_pop_gradient));
...
bool ImGui::SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags)
{
 ...
 //  it_anim->second.background_color = ImLerp(it_anim->second.background_color, IsItemActive() ? c::slider_active : hovered ? c::slider_hov : c::slider, g.IO.DeltaTime * 6.f);
 //  it_anim->second.background_slider = ImLerp(it_anim->second.background_slider, IsItemActive() ? c::bg_slider_active : hovered ? c::bg_slider_hov : c::bg_slider, g.IO.DeltaTime * 6.f);
    ...
    window->DrawList->AddRectFilled(frame_bb.Min + ImVec2(0, 8), frame_bb.Max - ImVec2(0, 3), GetColorU32(c::slider_background), 100);
    ...
    if (grab_bb.Max.x > grab_bb.Min.x) {
        ...
        const int vtx_idx_1 = ImGui::GetWindowDrawList()->VtxBuffer.Size;
        window->DrawList->AddRectFilled(frame_bb.Min + ImVec2(0, 8), frame_bb.Min + ImVec2(it_anim->second.slow - 7, 16.5f), GetColorU32(c::checkbox_gradient_start), 100, ImDrawFlags_RoundCornersLeft);
        ImGui::ShadeVertsLinearColorGradientKeepAlpha(ImGui::GetWindowDrawList(), vtx_idx_1, ImGui::GetWindowDrawList()->VtxBuffer.Size, frame_bb.Min, frame_bb.Max, GetColorU32(c::checkbox_gradient_start), GetColorU32(c::checkbox_gradient_end));

        const int vtx_idx_2 = ImGui::GetWindowDrawList()->VtxBuffer.Size;
        window->DrawList->AddCircleFilled(frame_bb.Min + ImVec2(it_anim->second.slow - 1, 12.f), 8, GetColorU32(c::circle_push_gradient), 100);
        ImGui::ShadeVertsLinearColorGradientKeepAlpha(ImGui::GetWindowDrawList(), vtx_idx_2, ImGui::GetWindowDrawList()->VtxBuffer.Size, frame_bb.Min, frame_bb.Min + ImVec2(7, 10), GetColorU32(c::circle_push_gradient), GetColorU32(c::circle_pop_gradient));
    }
...
namespace ImGui
{
    ...
    bool drawGrabber(const char* id, ImVec2& pos, t& input, const t& min, const t& max, float width, float height, int idnum)
    {
        ...
        it_anim->second.text_color = ImLerp(it_anim->second.text_color, IsItemActive() ? c::text_active : hovered ? c::text_hov : ImColor(0, 0, 0, 0), g.IO.DeltaTime * 6.f);
    ...
    bool RangeSlider(const char* id, const t& min, const t& max, t& low, t& high)
    {
        ...
        const int vtx_idx_1 = ImGui::GetWindowDrawList()->VtxBuffer.Size;
        win->DrawList->AddRectFilled({ pos.x + it_anim->second.min_slow / scale, pos.y + 34 }, { pos.x + it_anim->second.max_slow / scale, pos.y + height - 0 }, GetColorU32(c::checkbox_gradient_start), 100); //bar between the 2 grabbers
        ImGui::ShadeVertsLinearColorGradientKeepAlpha(ImGui::GetWindowDrawList(), vtx_idx_1, ImGui::GetWindowDrawList()->VtxBuffer.Size, { pos.x + it_anim->second.min_slow / scale, pos.y + 35 }, { pos.x + it_anim->second.max_slow / scale, pos.y + height - 0 }, GetColorU32(c::checkbox_gradient_start), GetColorU32(c::checkbox_gradient_end));
...
bool ImGui::InputTextEx(const char* label, const char* hint, char* buf, int buf_size, const ImVec2& size_arg, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback, void* callback_user_data)
{
    ...
    if (!is_multiline)
    {
        ...
        ImGui::ShadeVertsLinearColorGradientKeepAlpha(ImGui::GetWindowDrawList(), vtx_idx_1, ImGui::GetWindowDrawList()->VtxBuffer.Size, frame_bb.Min, ImVec2(frame_bb.Max.x - CalcItemWidth() - 54, frame_bb.Max.y), GetColorU32(c::input_push_gradient), GetColorU32(c::input_pop_gradient));
...
bool ImGui::Selectable(const char* label, bool selected, ImGuiSelectableFlags flags, const ImVec2& size_arg)
{
    ...
    it_anim->second.text_color = ImLerp(it_anim->second.text_color, selected ? c::text_active : hovered ? c::text_hov : c::text, g.IO.DeltaTime * 6.f);
